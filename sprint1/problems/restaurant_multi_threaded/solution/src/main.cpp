...
class Order : public std::enable_shared_from_this<Order> {
   ...
   private:
    ...
    void RoastCutlet() {
        ...
        roast_timer_.async_wait(net::bind_executor(strand_,
    ...
    void MarinadeOnion() {
        ...
        marinade_timer_.async_wait(net::bind_executor(strand_,
            [self = shared_from_this()](sys::error_code ec) {
                self->OnMarinaded(ec);
            }));
    }
...
int main() { 
    ...
    net::io_context io(threads_count);
